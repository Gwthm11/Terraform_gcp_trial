1.After bucketizing a customer, before the order fulfillment if the bundle rule changed whether need to rebucketize the customer?
2.If so, whether these customers will again come in the Lead list generated by sebastin? or how to identify these customers?
3.Where to track the marketing scrub team output (email, outbound call etc.)?
4.How to find whether customer is contacted or not by sales agent?
5.Where to capture customer response?
